...
#                 i = self._binary_search(self[:mid], key) 
#    
#             else: 
#                 i = self._binary_search(self[mid+1], key) 
#    
#         else: 
#             i = -1
#         return i
        ...
        while first <= last and not found:
            ...
            if self._values[midpoint] == key:
                i = midpoint
                found = True
            else:
                if key < self._values[midpoint]:
                    last = midpoint - 1
                else:
                    first = midpoint + 1
        return deepcopy(i)
    ...
    def clean(self):
        ...
        for i in self._values:
            if i not in newlist._values:
                newlist._values.append(i)
        self._values = deepcopy(newlist._values)
        del newlist
        ...
        while len(source1._values) != 0 or len(source2._values) != 0:
            if len(source1._values) == 0:
                while len(source2._values) != 0:
                    self._values.append(deepcopy(source2._values[0]))
                    del source2._values[0]
            elif len(source2._values) == 0:
                while len(source1._values) != 0:
                    self._values.append(deepcopy(source1._values[0]))
    ...
    def intersection(self, source1, source2):
        ...
        -------------------------------------------------------
        """
        templist = Sorted_List()
        
        for i in source1._values:
            if i not in templist._values and i in source2._values:
                templist._values.append(i)
        for i in templist._values:
...
#                 templist._values.append(i)
#                 
#         self._values = deepcopy(templist._values)
#         del templist
        i = self._binary_search(key)
        while i > -1:
            del self._values[i]
    ...
    def split(self):
        ...
        -------------------------------------------------------
        """
        halflist = (len(self._values) // 2) 
        if len(self._values) % 2 == 0:
            halflist -= 1
        target1 = Sorted_List()
        target2 = Sorted_List()
        
        target1._values = deepcopy(self._values[:halflist+1])
        target2._values = deepcopy(self._values[halflist+1:])
        self._values = []
    ...
    def split_alt(self):
        ...
        while len(self._values) != 0:
            target1._values.append(deepcopy(self._values[0]))
            del self._values[0]
            if len(self._values) != 0:
                target2._values.append(deepcopy(self._values[0]))
                del self._values[0]
        return target1, target2
    ...
    def split_key(self, key):
        ...
        if len(self._values) > 0:
            i = self._binary_search(key)
            if i > -1:
                target1._values = deepcopy(self._values[:i])
                target2._values = deepcopy(self._values[i:])
            else:
                if key > self._values[-1]:
                    target1._values = deepcopy(self._values)
                elif key <= self._values[0]:
                    target2._values = deepcopy(self.values)
            self._values = []
        return target1, target2
